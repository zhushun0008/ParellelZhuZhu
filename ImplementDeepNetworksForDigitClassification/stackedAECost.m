...
softmaxHiddenSize = hiddenSize + 1;
softmaxTheta = reshape(theta(1:softmaxHiddenSize * numClasses), numClasses, softmaxHiddenSize);

% Extract out the "stack"
stack = params2stack(theta(softmaxHiddenSize*numClasses+1:end), netconfig);
...
delta3 = (softmaxTheta(:,2:end)' * delta4) .* sigmoidGrad(z3);
% delta3 = (softmaxTheta * delta4) .* sigmoidGrad(z3);
